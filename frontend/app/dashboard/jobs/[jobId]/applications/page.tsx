...
function ApplicationCard({
  ...
  const openResume = () => {
    console.log("Application Resume URL:", application.resumeUrl)
    const URL=`http://localhost:3000/uploads/resumes/${application.resumeUrl.split("/")[5]}/${application.resumeUrl.split("/")[6]}`
